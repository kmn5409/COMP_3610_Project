...
def split_channels(file_, output_file, file_num):
    ...
    channels = ['testing_full_color_images', 'testing_output_images']
    ...
    for channel in range(1):
        ...
        for width in range(0, image.size[0], patch_size):
            ...
            for height in range(0, image.size[1], patch_size):
                ...
                patch.save(channels[channel] + '/' + color[channel] + '_testing_' + str(num) + '.TIF')
                output_patch.save(channels[channel+1] + '/' + 'testing_output_' + str(num) + '.TIF')
...
folders = ['testing_full_color_images', 'testing_output_images']
files.sort()
print(files_)
